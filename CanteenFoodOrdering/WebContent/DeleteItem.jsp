...
try{
	...
	<tr><th class="text-left" >Food Name</th><th class="text-left">Food Price</th></tr>
	<%
	...
	%><br><br>
<center><form name = "f1" action = "DeleteItemDB.jsp" onsubmit="return validateForm()">
ITEM NAME <input type = "text" name = "nameItem"><br><br>
<input type = "submit" value = "Delete Item">
</form>
</center>
<script>
function validateForm() {
    var name = document.forms["f1"]["nameItem"].value;
      if (name == "") {
        alert("Please enter the item name. It can't be empty!");
        return false;
    }
