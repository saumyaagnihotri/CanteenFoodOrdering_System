...
try{
	...
	PreparedStatement ps=c.prepareStatement("select * from feedbacks");
	
	ResultSet rs=ps.executeQuery();
	%>
	<table width = "100%" border = "2pt" class="table-fill">
	<tr><th class="text-left" >Name</th><th class="text-left">Feedback</th></tr>
	<%
	...
	while(rs.next())
	{
		...
		%>
		<tr align = "center">
		<td class="text-left"><%=i1%></td><td class="text-left"><%=i2%></td> 
